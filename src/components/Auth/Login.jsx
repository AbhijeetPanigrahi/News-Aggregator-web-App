        ...
        <div className="min-h-screen flex bg-background">
                ...
                <div className="mx-auto w-full max-w-sm lg:w-96">
                    ...
                    <div className="text-center lg:text-left">
                        ...
                        <p className="mt-2 text-sm text-text-secondary">
                            Sign in to continue to your Vertonews feed.
                        </p>
                    </div>
                    ...
                    <div className="mt-10">
                        ...
                        <div className="mt-8 text-center">
                            <p className="text-sm text-text-secondary">
                                ...
                                <Link to="/signup" className="font-bold text-primary-main hover:text-primary-dark transition-colors">
                                    Create one
                                </Link>
                            </p>
                        </div>
            ...
            <div className="hidden lg:block relative w-0 flex-1">
                ...
                <div className="absolute inset-0 z-20 flex flex-col justify-end p-20 text-white bg-gradient-to-t from-black/60 to-transparent">
                    <h3 className="text-4xl font-bold mb-4 drop-shadow-md">Welcome Back.</h3>
                    <p className="text-xl text-gray-200 drop-shadow-md max-w-lg">
                        Your personalized news feed is waiting for you.
                    </p>
                </div>
            </div>
        </div>
